...
//        'ir_shopsuggest',
        ...
        [
            ...
            'template'=>'{execapprv}',
            'buttons' => [
                'execapprv' => function ($url, $model, $key) {
                    return Html::a(' '.Html::icon('thumbs-up').' อนุมัติ', $url, ['class'=>'btn btn-default', 'title'=>'พัสดุ']);
                },
            ],
            'headerOptions' => [
                'width' => '70px',
    ...
    'options'=>['id'=>'dynagrid-irstaffexec'] // a unique identifier is important
]); ?>
</div>
