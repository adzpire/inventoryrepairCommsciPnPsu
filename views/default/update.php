...
<div class="panel panel-warning">
	<div class="panel-heading">
		...
		<?= Html::a( Html::icon('fire').' '.'ลบ', ['delete', 'id' => $model->ir_id], [
            ...
            'data' => [
                'confirm' => 'ต้องการลบข้อมูล? ท่านต้องลบรายการอุปกรณ์ให้หมดจึงจะลบสำเร็จ',
                'method' => 'post',
            ],
        ]) ?>
...
//                    ]
        ...
        <div class="col-md-12 form-group text-center">
            <h4>ขั้นตอน :</h4>
            <ol>
                <li class="text-danger">กรอกรายการอุปกรณ์ คลิ้กที่ปุ่ม [เพิ่มรายาร]</li>
            </ol>
...
//                $model->irdIvnt->attributeLabels()['invt_code'],
            ...
            'buttons' => [
                ...
                'deletedetail' => function ($url, $model, $key) {
                    return Html::a(Html::icon('trash'), $url, [
                        'class' => '_qdeletedetail btn btn-info',
                        'data-pjax' => 0,
                    ]);
                },
            ],
    ...
    'options'=>['id'=>'dynagrid-irdfupdate'] // a unique identifier is important
]); ?>
